...
-- duration.
ALTER TABLE "graph_edge" ALTER COLUMN "created_at" SET DATA TYPE timestamp (3) with time zone;--> statement-breakpoint
ALTER TABLE "graph_edge" ALTER COLUMN "updated_at" SET DATA TYPE timestamp (3) with time zone;--> statement-breakpoint
ALTER TABLE "graph_node" ALTER COLUMN "created_at" SET DATA TYPE timestamp (3) with time zone;--> statement-breakpoint
ALTER TABLE "graph_node" ALTER COLUMN "updated_at" SET DATA TYPE timestamp (3) with time zone;
